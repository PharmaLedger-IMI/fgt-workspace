...
#docker run --detach --hostname fgt --network="host" --publish 8080:8080 --mount source=external-volume,target=/fgt-workspace/apihub-root/external-volume --name $UCNAME --restart always pharmaledger/$UCNAME
