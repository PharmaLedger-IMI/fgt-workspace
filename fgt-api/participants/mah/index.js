...
function init(){
    initApis(express, api, 8081, APPS.MAH, getProductManager, getBatchManager, getStockManager, getSaleManager, getReceiptManager, getSimpleShipmentManager, getShipmentLineManager, getTraceabilityManager);
}
