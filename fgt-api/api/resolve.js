...
class ResolverApi extends Api {
    ...
    constructor(server, participantManager) {
        ...
        try {
            this.productManager = new (require('../../fgt-dsu-wizard/services/ProductService'))("traceability");
            this.batchManager = new (require('../../fgt-dsu-wizard/services/BatchService'))("traceability");
        } catch (e) {
