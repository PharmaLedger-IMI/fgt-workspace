let LOADER_GLOBALS = {
  ...
  <h1 class="display-6">Welcome to MAH traceability app!</h1>
  <p class="lead">After completing the following wizard you will gain access to Marketing Authorization Holder app.</p>
  <p class="m-0">In order to gain access you have to set up your credentials.</p>
  <hr/>
</div>`
};

module.exports = LOADER_GLOBALS;
