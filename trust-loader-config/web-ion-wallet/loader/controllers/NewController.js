...
function NewController() {
    ...
    if(LOADER_GLOBALS.environment.mode === "dev-secure"){
        if(!LOADER_GLOBALS.credentials.isValid){
            ...
            LOADER_GLOBALS.credentials.username = "WebCardinal Ionic Example"
            LOADER_GLOBALS.credentials.email = "test@pdm";
            LOADER_GLOBALS.credentials.company = "From PrivateSky";
            LOADER_GLOBALS.credentials.password = "UserSecurePassword1!";
