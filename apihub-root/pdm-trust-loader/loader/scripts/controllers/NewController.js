...
function NewController() {
    ...
    if(LOADER_GLOBALS.environment.mode === "dev-secure"){
        if(!LOADER_GLOBALS.credentials.isValid){
            ...
            LOADER_GLOBALS.credentials.username = "devwholesaleruser"
            LOADER_GLOBALS.credentials.email = "dev@wholesaleruser.dev";
            LOADER_GLOBALS.credentials.company = "Wholesaler Company Inc";
            LOADER_GLOBALS.credentials.password = "WholesalerUserSecurePassword1!";
