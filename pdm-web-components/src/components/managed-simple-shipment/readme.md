...
| `orderIdString`       | `order-id-string`       |             | `string` | `'Shipment Id:'`             |
...
graph TD;
  ...
  managed-simple-shipment --> create-manage-view-layout
  managed-simple-shipment --> pdm-barcode-scanner-controller
  ...
  style managed-simple-shipment fill:#f9f,stroke:#333,stroke-width:4px
```
