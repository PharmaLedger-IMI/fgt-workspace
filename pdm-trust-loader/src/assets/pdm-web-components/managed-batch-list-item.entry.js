...
import { g as getBarCodePopOver } from './popOverUtils-4121ec19.js';
...
const ManagedBatchListItem = class {
  ...
  render() {
    return (h(Host, null, h(Host, null, h("list-item-layout", null, this.addLabel(), this.addSerialsNumbers(), this.addButtons()))));
  }
