...
import { a as getDirectoryProducts, b as getDirectorySuppliers, c as getProductPopOver } from './popOverUtils-4121ec19.js';
...
const ManagedOrder = class {
  ...
  getCreate() {
    ...
    return [
      ...this.getInputs(),
      h("line-stock-manager", { lines: this.lines, "show-stock": false, "enable-actions": true, onSelectEvent: (evt) => this.selectOrderLine(evt), "lines-string": this.orderLinesString, "stock-string": this.stockString, "no-stock-string": this.noStockString, "select-string": this.selectString, "remaining-string": this.remainingString, "order-missing-string": this.orderMissingString, "available-string": this.availableString, "unavailable-string": this.unavailableString, "confirmed-string": this.confirmedString, "confirm-all-string": this.confirmAllString, "reset-all-string": this.resetAllString })
    ];
  }
  getPostCreate() {
    if (this.isCreate())
  ...
  getManage() {
    if (this.isCreate())
      return;
    return (h("line-stock-manager", { lines: this.lines, "show-stock": this.isCreate(), "enable-action": this.getType() === ORDER_TYPE.RECEIVED || this.isCreate(), "stock-string": this.stockString, "no-stock-string": this.noStockString, "select-string": this.selectString, "remaining-string": this.remainingString, "order-missing-string": this.orderMissingString, "available-string": this.availableString, "unavailable-string": this.unavailableString, "confirmed-string": this.confirmedString, "confirm-all-string": this.confirmAllString, "reset-all-string": this.resetAllString }));
  }
  getView() {
  }
  render() {
